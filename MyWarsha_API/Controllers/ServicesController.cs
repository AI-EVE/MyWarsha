...
namespace MyWarsha_API.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        {
            if (serviceCreateDto == null || serviceCreateDto.ProductsToSell.Count == 0 || serviceCreateDto.ServiceFees.Count == 0)
            {
                return BadRequest("Service must have at least one product to sell and one service fee");
            }
